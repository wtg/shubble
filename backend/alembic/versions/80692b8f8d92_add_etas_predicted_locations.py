"""add etas, predicted locations

Revision ID: 80692b8f8d92
Revises:
Create Date: 2026-01-08 23:21:50.575364
...
def upgrade() -> None:
    ...
    op.create_index(
        "ix_etas_vehicle_timestamp", "etas", ["vehicle_id", "timestamp"], unique=False
    )
    op.create_table(
        "geofence_events",
        sa.Column("id", sa.String(), nullable=False),
    ...
    op.create_index(
        "ix_predicted_locations_vehicle_timestamp",
        "predicted_locations",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "ix_predicted_locations_vehicle_timestamp", table_name="predicted_locations"
    )
